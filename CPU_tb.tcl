...
#this instruction will add the internal signals and ports of a component name CPU_Mem, which in this case is the memory block.
#this should be replaced by the name of the componenet in your top-level testbench
add_wave {{/cpu_tb/CPU_Mem}} 
...
#add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]} -radix hex {00000000}
...
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x00000011} {
...
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {20070011}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {00EB5822}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[3]} -radix hex {aceb000f}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[4]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[5]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[6]} -radix hex {00000000}
...
#check if the result is correct (result F010 E8EE A3E2 0B28)
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x00000014} {
...
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {20070011}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {00EB5821}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[3]} -radix hex {aceb000f}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[4]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[5]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[6]} -radix hex {00000000}
...
#check if the result is correct (result F010 E8EE A3E2 0B28)
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x0000000E} {
...
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {20070011}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {00075843}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[3]} -radix hex {aceb000f}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[4]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[5]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[6]} -radix hex {00000000}
...
#check if the result is correct (result F010 E8EE A3E2 0B28)
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x00000008} {
...
#check if the result is correct (result F010 E8EE A3E2 0B28)
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x00220000} {
...
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {20070011}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {28EB003F}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[3]} -radix hex {aceb000f}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[4]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[5]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[6]} -radix hex {00000000}
...
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x00000001} {
...
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {20070011}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {15670003}
...
#check if the result is correct
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x01234567} {
...
#check if the result is correct
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[12]}] == 0x00000123} {
...
#check if the result is correct
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x0000001A} {
...
#check if the result is correct
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[8]}] == 0x0000ff0f} {
...
#check if the result is correct
if {[get_value -radix unsigned {/cpu_tb/CPU_Mem/mw_U_0ram_table[9]}] == 0x0000bb0b} {
...
# you can use any of the following commands as an example on how to initilaize a memory location with a value
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[0]} -radix hex {200BFFFD}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[1]} -radix hex {05700003}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[2]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[3]} -radix hex {08000007}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[4]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[5]} -radix hex {03E00008}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[6]} -radix hex {00000000}
add_force {/cpu_tb/CPU_Mem/mw_U_0ram_table[7]} -radix hex {AC1F0020}

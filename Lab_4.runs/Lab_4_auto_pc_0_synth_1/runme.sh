...
HD_PWD='C:/Xilinx/Lab_4/Lab_4.runs/Lab_4_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_4_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_4_auto_pc_0.tcl

...
proc create_hier_cell_LAB_CPU { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 31 -to 0 MemoryAdress
  create_bd_pin -dir I -from 31 -to 0 MemoryDataIn
  create_bd_pin -dir O -from 31 -to 0 MemoryDataOut
  create_bd_pin -dir I -from 31 -to 0 -type rst Reset
  ...
  connect_bd_net -net CPU_0_MemoryAdress [get_bd_pins MemoryAdress] [get_bd_pins CPU_0/MemoryAdress]
  ...
  connect_bd_net -net Net1 [get_bd_pins CPU_0/MemoryWrite] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net CPU_0_MemoryAdress [get_bd_pins LAB_CPU/MemoryAdress] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net LAB_CPU_MemoryDataOut [get_bd_pins LAB_CPU/MemoryDataOut] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net MemoryDataIn_1 [get_bd_pins LAB_CPU/MemoryDataIn] [get_bd_pins blk_mem_gen_0/doutb]
